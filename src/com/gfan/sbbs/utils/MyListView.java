...
public class MyListView extends ListView implements OnScrollListener {
	...
	private void onModeSettings(){
		...
		if(isNightMode){
			...
			setDivider(new ColorDrawable(0xffCCCCCC));
			setDividerHeight(1);
		}
	}
	public void onScroll(AbsListView arg0, int firstVisiableItem, int visibleItemCount,
		...
		setLastItemIndex(firstVisiableItem + visibleItemCount - 2);
	}

	public void onScrollStateChanged(AbsListView arg0, int scrollState) {
		if(null != mLoadMoreListener && scrollState == SCROLL_STATE_IDLE){
	...
	public void onRefreshComplete() {
		...
		lastUpdatedTextView.setText("最近更新:" + df.format(new Date()));
		changeHeaderViewByState();
	}
	...
	public void setLoadMoreListener(OnLoadMoreDataListener mLoadMoreDataListener){
		this.mLoadMoreListener = mLoadMoreDataListener;
	}
